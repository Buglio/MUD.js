...
function chat_update(){
    ...
    const promptWidth = document.getElementById("prompt").style.width
    chatbox.innerHTML += '<input onblur="this.focus()" autofocus type="text" id="input" style="width="100% - '+promptWidth+'px ">'
